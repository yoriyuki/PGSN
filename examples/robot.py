...
pprint.pprint(src.pgsn.dsl.to_python(e1.fully_eval()), indent=2)

g1 = pgsn.gsn.goal(description="Vulnerability A is not exploited",
                                                     support=pgsn.gsn.evidence(description="Test results"))
pprint.pprint(src.pgsn.dsl.to_python(g1.fully_eval()), indent=2)

pprint.pprint(src.pgsn.dsl.to_python(s.fully_eval()), indent=2)
pprint.pprint(src.pgsn.dsl.to_python(robot.fully_eval()), indent=2)
...
if __name__ == '__main__':
    ...
    pprint.pprint(src.pgsn.dsl.to_python(system_evaluated), indent=2)
